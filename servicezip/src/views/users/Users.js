...
const Users = () => {
  ...
  const getUsers = async () => {
    setLoading(true);
    const users = await firebase.firestore().collection("orders").where("userType","==","Society").where("isCancelled","==",false).where("isCancelled","==",false).where("orderStatus","==","placed").get();
  ...
  const getPostorder = async () => {
    setLoading(true);
    const users = await firebase.firestore().collection("orders").where("userType","==","Society").where("isCancelled","==",false).where("isCancelled","==",false).where('orderStatus', '==', 'processed').get();
