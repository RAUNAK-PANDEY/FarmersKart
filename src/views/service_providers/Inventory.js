                            ...
                            <CInputGroup className="mb-3">
                                ...
                                <CDropdown>
                                  ...
                                  <CButton
                                    ...
                                    color="secondary"
                                    variant="outline"
                                    onClick={() => addBase(item.id,item.name)}
                                    >
                                    Add
                                    </CButton>
                      </td>
                    ...
                    <td style={{border:"1px solid #dee2e6", backgroundColor: "#ffffff"}}>
                                ...
                                <CDropdown>
                                  ...
                                  <CButton
                                    ...
                                    color="secondary"
                                    variant="outline"
                                    onClick={() => qout(item.id,item.name)}
                                    >
                                    Remove
                                    </CButton>
                    </td>
