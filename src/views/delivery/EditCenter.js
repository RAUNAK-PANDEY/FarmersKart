...
// $( ".delivery_time" ).val($( ".delivery-range" ).slider( "values", 0 ) + " - " + $( ".delivery-range" ).slider( "values", 1 ) );
  ...
  return (
    <CCard>
      <CCardHeader style={{ fontWeight: "bold",backgroundColor:"#f7f7f7",fontSize:"1.1rem",color: "black"}} >Add Centers</CCardHeader>
      <CCardBody>
        <CForm onSubmit={handleSubmit}>
          <CFormGroup>
          <CRow className="g-3 align-items-center">
                        <CCol md="2" sm="6">
                            <CLabel>Enter Center Name</CLabel>
                        </CCol>
                        <CCol md="4" sm={6}>
