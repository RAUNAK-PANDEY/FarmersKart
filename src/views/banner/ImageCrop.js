...
import {image64f} from './AddBanner'
import {image64av} from './EditBanner'
import {image64ad} from './AddAdvertisement'
import {image64ead} from './EditAdvertisement'
import {image64ep} from './EditPopup'
...
function image64 (canvas, crop) {
    if (!crop || !canvas) {
        ...
        //   console.log(myNewCroppedFile)
            ...
            alert('Image Cropped')
            image64f(myNewCroppedFile)
            image64av(myNewCroppedFile)
            image64ad(myNewCroppedFile)
            image64ead(myNewCroppedFile)
            image64ep(myNewCroppedFile)
